	...
	<body>
		<div class="wrapper">
			...
			<div class="sandbox">
				...
				<p><?php echo $gentlemen[1][first_name]; ?> is a rather dapper <?php echo $age_group[1]; ?>! He proudly wears a <?php echo $fu_manchu[name]; ?> moustache that is coloured a gentle <?php echo $fu_manchu[colour]; ?>.</p>
				
				<h3><?php echo $gentlemen[2][first_name]; ?> from <?php echo $gentlemen[2][country]; ?></h3>
				<p><?php echo $gentlemen[2][first_name]; ?> might seem too young for a 'stache because he is a <?php echo $age_group[0]; ?>! But he proudly displays his <?php echo $salvador_dali[name]; ?> moustache at school! Although it's a little hard to see because it's light <?php echo $salvador_dali[colour]; ?>.</p>
